...
const blogEntries: BlogEntry[] = [
    ...
    createBlogEntry(2, "25/5/2026", "Initial Tattoo Pencil Designs", ["1.jpg", "2.jpg", "3.jpg", "4.jpg" ,"5.jpg"], "Some of my first designs, all done with pencil. Would love to do these!", ["Spartan, Insect and knife-thing", "Dragon", "Eagle, Flower and Buffalo", "Vase of Flowers", "Vase of Flowers, Vase with a snake and Samurai"])
]
...
function getLensSize(): number {
    return window.innerWidth <= 768 ? 210 : 180 // If mobile view: bigger lens.
}

function applyZoom(clientX: number, clientY: number) {
